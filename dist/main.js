...
const counter_reducers_1 = __importDefault(
  require("./reducers/counter.reducers")
);
...
<<<<<<< HEAD
  react_dom_1.default.render(
    (0, jsx_runtime_1.jsx)(react_redux_1.Provider, {
      store: store,
      children: (0, jsx_runtime_1.jsx)(Counter_1.default, {
        value: store.getState().count,
        onIncrement: () => store.dispatch((0, actions_1.increment)()),
        onDecrement: () => store.dispatch((0, actions_1.decrement)()),
        onIncrementAsync: () =>
          store.dispatch((0, actions_1.delayedIncrement)()),
        onDecrementAsync: () =>
          store.dispatch((0, actions_1.delayedDecrement)()),
      }),
    }),
